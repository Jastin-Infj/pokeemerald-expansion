...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_MASQUERAIN}),
    },
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseAttack    = 60,
        .baseDefense   = 62,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 125 : 60,
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .baseAttack    = 65,
        .baseDefense   = 85,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 120 : 70,
        .baseSpAttack  = 105,
        .baseSpDefense = 75,
    ...
    [SPECIES_VOLBEAT] =
    {
        .baseHP        = 85,
        .baseAttack    = 73,
        .baseDefense   = P_UPDATED_STATS >= GEN_7 ? 105 : 55,
        .baseSpeed     = 125,
        .baseSpAttack  = 77,
