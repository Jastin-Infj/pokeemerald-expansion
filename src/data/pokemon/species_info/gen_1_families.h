...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 141 : 91)
    ...
    [SPECIES_ARBOK] =
    {
        ...
        .baseSpeed     = 95,
        .baseSpAttack  = 75,
        .baseSpDefense = P_UPDATED_STATS >= GEN_2 ? 89 : 65,
        .types = MON_TYPES(TYPE_POISON),
        .catchRate = 90,
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_PERSIAN}),
    },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .baseDefense   = 80,
        .baseSpeed     = 67,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 73 : 145,
        .baseSpDefense = 125,
        .types = MON_TYPES(TYPE_PSYCHIC),
        .catchRate = 75,
    ...
    [SPECIES_JYNX] =
    {
        ...
        .baseDefense   = 45,
        .baseSpeed     = 115,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_2 ? 135 : 95,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_ICE, TYPE_PSYCHIC),
        .catchRate = 45,
