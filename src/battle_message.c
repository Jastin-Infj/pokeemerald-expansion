...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_POKEMONVENDORBONDEXPGAINED]           = COMPOUND_STRING("Sealed bond EXP increased by {B_BUFF1}.\p"),
    [STRINGID_POKEMONVENDORRECRUITSUNLOCKED]        = COMPOUND_STRING("{B_BUFF2} sealed recruit(s) were unlocked.\p"),
