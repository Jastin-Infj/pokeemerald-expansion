...
const u8 gText_PokemonVendorLocked[] = _("LOCKED");
const u8 gText_PokemonVendorSealedBond[] = _("Locked bond: {STR_VAR_1}/{STR_VAR_2}\nIt can't battle yet.");
const u8 gText_PokemonVendorSealedMemo[] = _("A sealed POKéMON recruited\nfrom a friendly shop.");
const u8 gText_PokemonVendorOriginMemo[] = _("A shop-recruited POKéMON.\nIts bond is fully unlocked.");
