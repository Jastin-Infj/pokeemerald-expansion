...
static const u8 LandmarkName_NewArea[] = _("NEW AREA");
...
static const struct Landmark Landmark_NewArea = {LandmarkName_NewArea, FLAG_LANDMARK_New_AREA};
...
static const struct Landmark *const Landmarks_Route999_1[]  =
{
    &Landmark_AlteringCave,
    NULL,
};
...
static const struct LandmarkList sLandmarkLists[] =
{
    ...
    {MAPSEC_ROUTE_999, 1, Landmarks_Route999_1},
#ifdef BUGFIX
