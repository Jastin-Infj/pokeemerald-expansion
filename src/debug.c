...
{
    { COMPOUND_STRING("Route301 Fly"), DebugAction_ExecuteScript, Debug_EventScript_Script_1 },
    { COMPOUND_STRING("Warp Route301"), DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
