...
- [Local Tooling]()
    ...
    - [mGBA Live Init And Build Validation](tools/mgba_live_init_build_validation.md)
...
- [Project Manuals]()
    ...
    - [XY Status HUD Implementation](features/xy_status_hud_implementation.md)
      - [Design Constraints](features/xy_status_hud_constraints.md)
      - [Test Plan](features/xy_status_hud_test_plan.md)
    ...
    - [1.15.3 Feature Tree](features/15_3/README.md)
    - [1.15.3 CompleteTree](features/15_3/complete_tree/README.md)
    - [1.15.3 Completed Features](features/15_3/complete_tree/completed_features.md)
    - [Runtime Integration Branch Audit 2026-05-29](features/15_3/complete_tree/completed_branch_audit_2026_05_29.md)
    - [1.15.3 Runtime Integration Checklist JA 2026-05-30](features/15_3/complete_tree/completed_runtime_integration_checklist_ja_2026_05_30.md)
    - [1.15.3 Runtime Summary](features/15_3/complete_tree/completed_runtime_summary.md)
    - [1.15.3 Runtime Config / Debug Matrix](features/15_3/complete_tree/completed_config_debug_matrix.md)
...
- [Investigation Notes]()
    ...
    - [Save Data / Runtime Flags Flow v15](flows/save_data_flow_v15.md)
    ...
    - [Map Creation Flow v15](flows/map_creation_flow_v15.md)
    - [Move Relearner Flow v15](flows/move_relearner_flow_v15.md)
    - [Pokemon Icon UI Flow v15](flows/pokemon_icon_ui_flow_v15.md)
    ...
    - [Future Feature Candidates](features/future_feature_candidates.md)
      ...
      - [Route Mastery Passport](features/route_mastery_passport/README.md)
      - [Trainer Titles / Achievement Badges](features/trainer_titles_achievement_badges/README.md)
    - [TM Shop Migration](features/tm_shop_migration/README.md)
      - [Investigation](features/tm_shop_migration/investigation.md)
      - [MVP Plan](features/tm_shop_migration/mvp_plan.md)
      - [Implementation](features/tm_shop_migration/implementation.md)
      - [Risks](features/tm_shop_migration/risks.md)
      - [Test Plan](features/tm_shop_migration/test_plan.md)
    - [Bag Expansion](features/bag_expansion/README.md)
      - [Investigation](features/bag_expansion/investigation.md)
      - [MVP Plan](features/bag_expansion/mvp_plan.md)
      - [Risks](features/bag_expansion/risks.md)
      - [Test Plan](features/bag_expansion/test_plan.md)
    - [Field Move Modernization / HM Removal](features/field_move_modernization/README.md)
      - [Investigation](features/field_move_modernization/investigation.md)
      - [MVP Plan](features/field_move_modernization/mvp_plan.md)
      - [Implementation](features/field_move_modernization/implementation.md)
      - [Risks](features/field_move_modernization/risks.md)
      - [Test Plan](features/field_move_modernization/test_plan.md)
    ...
    - [Trainer Battle Party Selection](features/battle_selection/README.md)
      - [MVP Plan](features/battle_selection/mvp_plan.md)
      - [Implementation](features/battle_selection/implementation.md)
      - [Test Plan](features/battle_selection/test_plan.md)
      - [Risks](features/battle_selection/risks.md)
    ...
    - [Smart Gimmick AI](features/smart_gimmick_ai/README.md)
      ...
      - [Runtime Re-evaluation Spec](features/smart_gimmick_ai/runtime_reevaluation_spec.md)
      - [Test Plan](features/smart_gimmick_ai/test_plan.md)
    - [Box NPC Party Pool](features/box_npc_party_pool/README.md)
      - [Goal](features/box_npc_party_pool/goal.md)
      - [Implementation](features/box_npc_party_pool/implementation.md)
      - [Test Plan](features/box_npc_party_pool/test_plan.md)
    - [Battle Team Boxes](features/battle_team_boxes/README.md)
      - [Goal and Dependencies](features/battle_team_boxes/goal.md)
      - [Implementation](features/battle_team_boxes/implementation.md)
      - [Test Plan](features/battle_team_boxes/test_plan.md)
    - [Runtime Lab Integration](features/runtime_lab_integration/README.md)
      - [Goal and Dependencies](features/runtime_lab_integration/goal.md)
      - [Implementation and Handoff](features/runtime_lab_integration/implementation.md)
      - [Test Plan](features/runtime_lab_integration/test_plan.md)
    - [Pre-Battle / In-Battle Team Viewer](features/prebattle_team_viewer/README.md)
      ...
      - [MVP Plan](features/prebattle_team_viewer/mvp_plan.md)
      - [Implementation](features/prebattle_team_viewer/implementation.md)
      - [Dependencies](features/prebattle_team_viewer/dependencies.md)
      - [Risks](features/prebattle_team_viewer/risks.md)
      - [Test Plan](features/prebattle_team_viewer/test_plan.md)
      - [Legacy Console References](features/prebattle_team_viewer/legacy_console_references.md)
    - [Summary Tera Type Icon](features/summary_tera_type_icon/README.md)
      - [Investigation](features/summary_tera_type_icon/investigation.md)
      - [MVP Plan](features/summary_tera_type_icon/mvp_plan.md)
      - [Asset References](features/summary_tera_type_icon/asset_references.md)
      - [Implementation](features/summary_tera_type_icon/implementation.md)
    ...
    - [Pokemon State Editor](features/pokemon_state_editor/README.md)
      ...
      - [Investigation](features/pokemon_state_editor/investigation.md)
      - [MVP Plan](features/pokemon_state_editor/mvp_plan.md)
      - [Implementation](features/pokemon_state_editor/implementation.md)
      - [Risks](features/pokemon_state_editor/risks.md)
      - [Test Plan](features/pokemon_state_editor/test_plan.md)
    ...
    - [Trainer Battle Aftercare / Forced Release](features/trainer_battle_aftercare/README.md)
      - [Investigation](features/trainer_battle_aftercare/investigation.md)
      - [MVP Plan](features/trainer_battle_aftercare/mvp_plan.md)
      - [Implementation](features/trainer_battle_aftercare/implementation.md)
      - [Risks](features/trainer_battle_aftercare/risks.md)
      - [Test Plan](features/trainer_battle_aftercare/test_plan.md)
