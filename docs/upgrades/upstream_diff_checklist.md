...
| TM/HM / field move | `include/constants/tms_hms.h`, `include/item.h`, `src/item.c`, `src/item_use.c`, `src/item_menu.c`, `src/field_move.c`, `include/field_move.h`, `data/scripts/field_move_scripts.inc`, `src/party_menu.c`, `src/pokemon.c` | TM/HM 追加、field HM removal、forget HM、field move script |
...
git diff OLD_REV..NEW_REV -- include/constants/tms_hms.h include/item.h src/item.c src/item_use.c src/item_menu.c src/field_move.c include/field_move.h data/scripts/field_move_scripts.inc
