...
|---|---|---|---|---|
| `OW_FLAG_NO_ENCOUNTER` | Event flag id config | `docs/features/no_random_encounters/` | `include/config/overworld.h` で `0`。未割り当て。 | bool ではない。`TRUE` / `1` ではなく `FLAG_UNUSED_*` など明示 flag id を割り当てる。 |
