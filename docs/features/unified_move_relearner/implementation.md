...
| Special pool | `tools/learnset_helpers/special_relearner_moves.json` adds project-owned runtime data for special event, distribution-only, XD purification, and Ranger-transfer move candidates. |
