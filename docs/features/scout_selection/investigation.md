...
| Build tools / generated files | Not needed for MVP. Future partygen-derived pools can be generated data. |
...
- Whether candidates are pre-built `struct Pokemon` or lightweight specs converted on selection.
