...
MVP implemented. Build / check / mGBA boot smoke passed on 2026-05-09.
Direct selection-screen manual validation remains open.
...
2026-05-09 時点では prepared save / savestate が無いため、上記 manual matrix は未実行。
boot と input 経路は mGBA Live で確認済みだが、selection UI 表示、battle start、
restore は manual remaining check として扱う。
