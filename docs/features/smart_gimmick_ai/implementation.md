...
- 2026-06-06 `rtk make -j16 -O check TESTS='AI_FLAG_READ_PLAYER_MOVE'`: pass, 3 tests. Covers the read-player-move Fake Out Dynamax regression, the selected-player-Tera damage read, and the actual selected switch-in read.
