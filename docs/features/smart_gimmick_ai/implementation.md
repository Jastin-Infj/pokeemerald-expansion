...
- Aggressive gimmick pressure: spends Dynamax, Tera, or a damaging Z-Move on a configured 85% pressure route while reserves still exist.
...
- 2026-06-06 `rtk make -j16 -O check TESTS='AI_FLAG_AGGRESSIVE_GIMMICK'`: pass, 2 tests. Covers the aggressive 85% Dynamax and damaging Z-Move pressure route with reserves.
