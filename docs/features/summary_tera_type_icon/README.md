...
| Working branch | `feature/summary-tera-type-badge` / completed shelf #26 |
| Baseline | `master` `c13184c0b1`; `git describe` = `expansion/1.15.2-45-gc13184c0b1` |
| Code status | Validated branch; completed shelf #26 closed 2026-05-17 after CI success; not on `master` |
