...
# Add generated headers to include paths without affecting AUTO_GEN dependencies
INCLUDE_CPP_ARGS += -iquote generated
INCLUDE_SCANINC_ARGS += -I generated
...
# area-based randomizer tables are generated by a Python script
RANDOMIZER_RULES := generated/randomizer_area_rules.h
AUTO_GEN_TARGETS += $(RANDOMIZER_RULES)
RANDOMIZER_ITEM_TABLE_CHECK := generated/randomizer_item_table.ok
AUTO_GEN_TARGETS += $(RANDOMIZER_ITEM_TABLE_CHECK)
TRAINER_RANK_WEIGHT_MODE ?= 100
TRAINER_RANK_RULES := generated/trainer_rank_parties.h
TRAINER_RANK_TAGS := generated/trainer_rank_tags.h
AUTO_GEN_TARGETS += $(TRAINER_RANK_RULES) $(TRAINER_RANK_TAGS)
...
$(RANDOMIZER_RULES): dev_scripts/build_randomizer_area_rules.py data/randomizer/area_rules.yml
	python3 dev_scripts/build_randomizer_area_rules.py --in data/randomizer/area_rules.yml --out $(RANDOMIZER_RULES)

$(RANDOMIZER_ITEM_TABLE_CHECK): dev_scripts/validate_randomizer_item_table.py src/data/randomizer/item_table.h src/data/randomizer/item_category_config.h include/randomizer.h include/config/randomizer.h src/data/items.h
	python3 dev_scripts/validate_randomizer_item_table.py --out $@

$(TRAINER_RANK_RULES) $(TRAINER_RANK_TAGS): dev_scripts/build_trainer_rank_parties.py $(wildcard data/trainer_rank_party/*.party) src/data/trainers.party src/data/randomizer/trainer_skip_list.h
	python3 dev_scripts/build_trainer_rank_parties.py --dir data/trainer_rank_party --trainer src/data/trainers.party --skip src/data/randomizer/trainer_skip_list.h --out $(TRAINER_RANK_RULES) --tags-out $(TRAINER_RANK_TAGS) --mode $(TRAINER_RANK_WEIGHT_MODE)
...
$(C_BUILDDIR)/randomizer.o: c_dep += $(RANDOMIZER_RULES)
