...
SCOUT_SELECTION_PARTYGEN_SET_JSONS := \
	$(TOOLS_DIR)/champions_partygen/catalog/sets/hoenn_demo.json \
	$(TOOLS_DIR)/champions_partygen/catalog/sets/elite_four.json
AUTO_GEN_TARGETS += $(DATA_SRC_SUBDIR)/scout_selection_pools.h

$(DATA_SRC_SUBDIR)/scout_selection_pools.h: $(SCOUT_SELECTION_TOOL_DIR)/make_scout_pools.py $(SCOUT_SELECTION_PARTYGEN_SET_JSONS)
	python3 $(SCOUT_SELECTION_TOOL_DIR)/make_scout_pools.py $@ $(SCOUT_SELECTION_PARTYGEN_SET_JSONS)
