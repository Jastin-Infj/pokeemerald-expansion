...
AUTO_GEN_TARGETS += $(TRAINER_RANK_RULES)
...
$(TRAINER_RANK_RULES): dev_scripts/build_trainer_rank_parties.py $(wildcard data/trainer_rank_party/*.party) src/data/trainers.party src/data/randomizer/trainer_skip_list.h
	python3 dev_scripts/build_trainer_rank_parties.py --dir data/trainer_rank_party --trainer src/data/trainers.party --skip src/data/randomizer/trainer_skip_list.h --out $(TRAINER_RANK_RULES) --mode $(TRAINER_RANK_WEIGHT_MODE)
