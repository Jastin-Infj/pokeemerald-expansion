...
#define VAR_BATTLE_FIELD_WEATHER                         0x4064 // Battle init Weather
#define VAR_BATTLE_FIELD_STATUS                          0x4065 // Battle init Field Status
...
#define VAR_DN_SPECIES                                   0x40F7 // Devnav
#define VAR_DN_STEP_COUNTER                              0x40F8 // Devnav
