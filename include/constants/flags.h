...
#define FLAG_ENABLE_DYNAMAX  0x264 // Unused Flag
#define FLAG_ENABLE_TERA_BATTLE  0x265 // Unused Flag
#define FLAG_ENABLE_TERA_ORB_CHARGED  0x266 // Unused Flag
...
#define FLAG_LANDMARK_New_AREA                      (SYSTEM_FLAGS + 0x85) // New flag
