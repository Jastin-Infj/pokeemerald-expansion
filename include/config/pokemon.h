...
#define P_VAR_MOVE_RELEARNER_STATE       VAR_0x8000   // IMPORTANT! Assign a var to make the move relearner swap between level up, egg, TM and tutor.
...
#define P_FLAG_PARTY_MOVE_RELEARNER      TRUE   // If this flag is set, it enables the move relearner in the party menu.
...
#define P_FLAG_LEVEL_UP_MOVES            TRUE      // If this flag is set, enables level up move relearner.
#define P_FLAG_EGG_MOVES                 TRUE      // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               TRUE      // If this flag is set, enables tutor move move relearner.
