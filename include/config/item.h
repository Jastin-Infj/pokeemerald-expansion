...
#define I_HELD_ITEM_CATALOG_ASSIGNMENT  TRUE        // If TRUE, non-mail held item assignment treats one Bag copy as ownership permission instead of consuming / returning physical Bag quantity.
