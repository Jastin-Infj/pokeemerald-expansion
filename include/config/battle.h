...
#define B_TRAINER_BATTLE_AFTERCARE  FALSE      // If TRUE, normal trainer battle wins heal the player's party after battle. Special facilities and custom trainer branches are excluded.
