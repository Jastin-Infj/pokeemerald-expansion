...
#define B_FLAG_ITEMLESS_GIMMICK_BATTLE 0  // If this flag is set, explicit trainer Z-Move candidates can use type-based Z-Moves without Z-Crystals, and the player can use supported itemless gimmicks in this battle.
