...
// Smart/read-mode ceilings include bounded short-horizon board evaluation.
#define AI_FRAME_CEILING_SINGLES_NO_FLAGS                       3
#define AI_FRAME_CEILING_SINGLES_SMART_TRAINER                 12
#define AI_FRAME_CEILING_DOUBLES_NO_FLAGS                       21
#define AI_FRAME_CEILING_DOUBLES_SMART_TRAINER                  70
#define AI_FRAME_CEILING_STEVEN_MULTI                           54
#define AI_FRAME_CEILING_STEVEN_MULTI_SMART_TRAINER             68
